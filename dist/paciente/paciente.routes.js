...
import { findAll, findOne, add, update, remove, sanitizePacienteInput, login, logout, obtenerTurnos, obtenerPaciente } from './paciente.controller.js';
...
pacienteRouter.post('/', validatePaciente, validarErrores, sanitizePacienteInput, add, login);
pacienteRouter.put('/:id', authToken, authorizeRole('P'), validatePaciente, validarErrores, sanitizePacienteInput, update);
...
pacienteRouter.patch('/k/:id', authToken, authorizeRole('P'), validatePacienteUpdate, validarErrores, sanitizePacienteInput, update);
